-- Enums
DO $$ BEGIN CREATE TYPE invoice_status AS ENUM ('UNPAID','PARTIAL','PAID','CANCELLED'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE cash_account_type AS ENUM ('CASH','BANK'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE cash_tx_kind AS ENUM ('IN','OUT'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE payment_method AS ENUM ('TUNAI','TRANSFER','QRIS','VA','LAINNYA'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE fee_recurrence AS ENUM ('ONCE','MONTHLY'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
